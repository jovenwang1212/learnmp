...
var x=['./components/SearchLink.wxml','./pages/home/index.wxml'];d_[x[0]]={}
var m0=function(e,s,r,gg){
var z=gz$gwx_1()
var oB=_mz(z,'view',['bindtap',0,'class',1,'data-event-opts',1],[],e,s,gg)
var xC=_n('view')
_rz(z,xC,'class',3,e,s,gg)
var oD=_mz(z,'icon',['class',4,'color',1,'size',2,'type',3],[],e,s,gg)
_(xC,oD)
var fE=_n('label')
...
var cI=_mz(z,'search-link',['bind:__l',1,'vueId',1],[],e,s,gg)
_(oH,cI)
var oJ=_mz(z,'swiper',['autoplay',-1,'circular',-1,'indicatorDots',-1,'indicatorActiveColor',3,'indicatorColor',1],[],e,s,gg)
var lK=_v()
_(oJ,lK)
var aL=function(eN,tM,bO,gg){
var xQ=_n('swiper-item')
var oR=_n('image')
_rz(z,oR,'src',9,eN,tM,gg)
_(xQ,oR)
_(bO,xQ)
return bO
}
...
var aZ=_n('view')
var t1=_mz(z,'image',['alt',-1,'class',15,'src',1],[],cW,oV,gg)
_(aZ,t1)
_(oX,aZ)
return oX
}
cT.wxXCkey=2
_2z(z,13,hU,e,s,gg,cT,'item','index','index')
_(oH,fS)
var e2=_n('view')
var b3=_v()
_(e2,b3)
...
var h9=_n('view')
_rz(z,h9,'class',21,o6,x5,gg)
var o0=_mz(z,'image',['alt',-1,'class',22,'src',1],[],o6,x5,gg)
_(h9,o0)
var cAB=_n('view')
_rz(z,cAB,'class',24,o6,x5,gg)
var oBB=_mz(z,'image',['alt',-1,'class',25,'src',1],[],o6,x5,gg)
_(cAB,oBB)
var lCB=_n('view')
_rz(z,lCB,'class',27,o6,x5,gg)
var aDB=_v()
_(lCB,aDB)
var tEB=function(bGB,eFB,oHB,gg){
var oJB=_v()
_(oHB,oJB)
if(_oz(z,32,bGB,eFB,gg)){oJB.wxVkey=1
var fKB=_mz(z,'image',['alt',-1,'class',33,'src',1],[],bGB,eFB,gg)
_(oJB,fKB)
}
oJB.wxXCkey=1
return oHB
...
aDB.wxXCkey=2
_2z(z,30,tEB,o6,x5,gg,aDB,'item','index','index')
_(cAB,lCB)
_(h9,cAB)
_(f7,h9)
return f7
...
b3.wxXCkey=2
_2z(z,19,o4,e,s,gg,b3,'floor','fIndex','fIndex')
_(oH,e2)
_(r,oH)
return r
}
